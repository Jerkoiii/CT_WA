...
<head>
    ...
    <title>tungol Division</title>
    <link rel="stylesheet" href="tungolcalcu.css">

</head>
<body>
    <form action="tungolDivision.php" method="POST">
        <h2>
            <table>
                <h1>DIVISION</h1>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        if(isset($_POST['compute'])){
                            ...
                            $tungol_Quotient = $tungol_FirstNumber / $tungol_SecondNumber; echo $tungol_Quotient;

                            $compute = mysqli_query($tungol_CONNECTION, "INSERT INTO tungolDivision(tungol_FirstNumber, tungol_SecondNumber, tungol_Quotient)
                            VALUES ('$tungol_FirstNumber', '$tungol_SecondNumber', '$tungol_Quotient')");
                        }
                        ?>">
                    </td>
                </tr>
