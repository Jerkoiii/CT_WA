...
<head>
    ...
    <title>tungol Subtraction</title>
    <link rel="stylesheet" href="tungolcalcu.css">

</head>
<body>
    <form action="tungolSubtraction.php" method="POST">
        <h2>
            <table>
                <h1>SUBTRACTION</h1>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        if(isset($_POST['compute'])){
                            ...
                            $tungol_Difference = $tungol_FirstNumber - $tungol_SecondNumber; echo $tungol_Difference;

                            $compute = mysqli_query($tungol_CONNECTION, "INSERT INTO tungolSubtraction(tungol_FirstNumber, tungol_SecondNumber, tungol_Difference)
                            VALUES ('$tungol_FirstNumber', '$tungol_SecondNumber', '$tungol_Difference')");
                        }
                        ?>">
                    </td>
                </tr>
